...
public class ItemDAO {
    ...
    // 建立範例資料
    public void sample() {
        Item item = new Item(0, new Date().getTime(), "關於Android Tutorial的事情.", "Hello content", "", "", 0);
        Item item2 = new Item(0, new Date().getTime(), "一隻非常可愛的小狗狗!", "她的名字叫「大熱狗」，又叫\n作「奶嘴」，是一隻非常可愛\n的小狗。", "", "", 0);
        Item item3 = new Item(0, new Date().getTime(), "一首非常好聽的音樂！", "Hello content", "", "", 0);
        Item item4 = new Item(0, new Date().getTime(), "儲存在資料庫的資料", "Hello content", "", "", 0);
